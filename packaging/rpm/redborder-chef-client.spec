...
mkdir -p %{buildroot}/etc/chef/ohai/plugins/
install -D -m 0644 resources/ohai/plugins/redborder.rb %{buildroot}/etc/chef/ohai/plugins/redborder.rb
...
/etc/chef/ohai/plugins/redborder.rb
